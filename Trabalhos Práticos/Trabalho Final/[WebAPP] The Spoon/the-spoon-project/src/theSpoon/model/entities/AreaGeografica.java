...
public class AreaGeografica {
	...
	public AreaGeografica(int codigoPostal, String zonaPostal) {
		super();
		this.codigoPostal = codigoPostal;
		this.zonaPostal = zonaPostal;
	}

	public AreaGeografica(int codigoPostal, String zonaPostal, String freguesia, String concelho, String distrito) {
		super();
		this.codigoPostal = codigoPostal;
		this.zonaPostal = zonaPostal;
